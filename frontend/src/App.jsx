...
function ParticipateScreen({ onComplete, onExit, surveyId }) {
...
function App() {
  ...
  const screens = {
    ...
    participate: <ParticipateScreen navigate={navigate} onComplete={completeSurvey} onExit={() => navigate(participationSource)} surveyId={activeSurveyId} />,
